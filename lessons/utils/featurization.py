...
class Bow:
    ...
    def transform(self,data):
        if len(self.all_word) == 0:
            raise AttributeError('You must fit the data first')
...
class TDIDF:
    ...
    def fit(self,data):
        ...
        for word_position in range(len(document_words)):
            ...
            self.word_to_index[word] = word_position
    ...
    def _transform_document(self,data):
        ...
        for sent in data:
            sentence_arrays.append(self._tranform_sentence(sent))
    ...
    def _tranform_sentence(self,data):
        ...
        sent_td_idf = self._compute_sentence_tf_idf(data)
